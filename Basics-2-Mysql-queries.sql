show databases;
create database if not exists ineuron_fsds ;
...
/* Basic queries on the above dataset */

/* Try to find out average of balance column? */
select avg(balance) from bank_details;

/*Try to find out sum of balance column?*/
select sum(balance) from bank_details;

/* Try to find out who is having a minimum balance? in different ways*/
...
/* Try to find out who is having a maximum balance?  in different ways*/
...
/* try to prepare a list of all the persons who is having loan */
select * from bank_details where loan = 'yes';

/* try to findout average balance for all the people whose job role is 'admin' */
...
/* Try to find out a record, whose is not having house at all along with balance column */ 
